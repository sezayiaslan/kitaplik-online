...
public class BookServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Book book1 = new Book(1L,"Günyanın Gözü",2000,"Robert Jordan","abc","1234");
		Book book2 = new Book(2L,"Yüzüklerin Efendisi",1960,"J.R.R Tolkien","abc","4567");
		Book book3 = new Book(3L,"Harry Potter ve Felsefe Taşı",1997,"J.K","abc","5678");
